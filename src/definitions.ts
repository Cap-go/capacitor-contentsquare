...
export interface ContentsquareNativePlugin {
  optIn(): Promise<void>;
  optOut(): Promise<void>;
  sendScreenName(options: { name: string }): Promise<void>;
  ...
  excludeURLForReplay(options: { url: string }): Promise<void>;
  setPIISelectors(pii: PIIConfig): Promise<void>;
  setCapturedElementsSelector(options: { elements: string }): Promise<void>;
